...
import { Position, PositionData } from './page';
...
const ApplicationFormClient = ({ positionId, positionData }: ApplicationFormClientProps) => {
  ...
  }, [positionId, positionData, router]);
...
export default ApplicationFormClient; 