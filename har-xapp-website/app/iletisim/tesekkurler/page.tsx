...
// Static export uyumlu teşekkür sayfası
const ThankYouPage = () => {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setCountdown(prev => {
        if (prev <= 1) {
          clearInterval(timer);
          // Use window.location instead of router for static export
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/"
                className="px-8 py-3 bg-gradient-to-r from-primary to-secondary text-white rounded-lg font-medium hover:shadow-lg transition-all inline-block"
              >
                Ana Sayfaya Dön
              </Link>
            </div>
